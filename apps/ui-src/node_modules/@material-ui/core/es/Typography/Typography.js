...
function getVariant(theme, props, variantProp) {
  ...
  process.env.NODE_ENV !== "production" ? warning(typography.suppressDeprecationWarnings || props.internalDeprecatedVariant && typography.useNextVariants || !typographyMigration.deprecatedVariants.includes(variant), 'Material-UI: You are using the deprecated typography variant ' + `${variant} that will be removed in the next major release. ${typographyMigration.migrationGuideMessage}`) : void 0; // complete v2 switch
  ...
  process.env.NODE_ENV !== "production" ? warning(typography.suppressDeprecationWarnings || !typographyMigration.restyledVariants.includes(variant), 'Material-UI: You are using the typography variant ' + `${variant} which will be restyled in the next major release. ${typographyMigration.migrationGuideMessage}`) : void 0;
  return variant;
}
