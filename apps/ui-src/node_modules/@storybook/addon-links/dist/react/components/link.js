...
function (_PureComponent) {
  ...
  _createClass(LinkTo, [{
    ...
    key: "updateHref",
    value: function () {
      var _updateHref = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee() {
        var _this$props2, kind, story, href;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props2 = this.props, kind = _this$props2.kind, story = _this$props2.story;
                _context.next = 3;
      ...
      function updateHref() {
        return _updateHref.apply(this, arguments);
      }
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props3, ["kind", "story"]);

      var href = this.state.href;
      return _react.default.createElement(_RoutedLink.default, _extends({
        href: href,
