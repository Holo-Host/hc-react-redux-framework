    ...
    value: function () {
      function parents(selector) {
        ...
        var allParents = this.wrap(this.single('parents', function (n) {
          return (0, _RSTTraversal.parentsOfNode)(n, getRootNodeInternal(_this14));
        }));
    ...
    value: function () {
      function shallow(options) {
        ...
        return this.single('shallow', function (n) {
          return _this15.wrap((0, _getAdapter2['default'])(_this15[OPTIONS]).nodeToElement(n), null, options);
        });
      }
    ...
    value: function () {
      function dive() {
        ...
        return this.single(name, function (n) {
          ...
          var el = (0, _getAdapter2['default'])(_this24[OPTIONS]).nodeToElement(n);
